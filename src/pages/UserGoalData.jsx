    ...
    userService
      ...
      .then((response) => {
        ...
        if (response.data.data) {
          ...
          setUserGoal(response.data.data.goals);
        }
      })
      ...
      <Container>
        <Row>
          ...
          <Col md={10} xs={10} className="doctor-top">
            ...
            {userGoal.length > 0 ? userGoal.map((item, index) => {
              return (
                  ...
                  <CardBody>
                    ...
                    <Col md={4} sm={12} className="p-2">
                      ...
                      <Col md={4} sm={12} className="p-2">
                        <span>
                          <b>Date:</b>{" "}
                          {moment(item.goalStartDate).format("ddd, D/M/Y, hh:mm:ss A")}
                        </span>
                      </Col>
                      <Col md={4} sm={12} className="p-2">
                        <span>
                          <b>Date:</b>{" "}
                          {moment(item.goalEndDate).format("ddd, D/M/Y, hh:mm:ss A")}
                        </span>
                      </Col>  
                    </Row>
                  </CardBody>
            ...
            }): <><h3 style={{textAlign:'center'}}>!Ops User Not Provide Goal Data</h3></>}
          </Col>
          <Col xs={1}></Col>
        </Row>
      </Container>
